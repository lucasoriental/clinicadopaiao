  ...
  return (
    <div className="container-geral">
      ...
      <div className="paragrafos-geral">
        <p>
          As consultas de Clínica Geral destinam-se à prevenção, diagnóstico e
          orientação terapêutica não cirúrgica de doenças para indivíduos acima
          de 16 anos.​
        </p>
        <p>
          Este serviço inclui avaliação de rotina, prescrição de análises,
          exames e receitas médicas, emissão do atestado para a carta de
          condução, medicina desportiva, consultas de urgência e consultas ao
          domicílio.
        </p>
        <p>
